    ...
    <div className="w-full bg-zinc-950 rounded-xl p-3 border border-zinc-800 space-y-2">
      ...
      <svg viewBox="0 0 400 185" className="w-full h-auto select-none">
        ...
        <g transform="translate(18, 142)">
          ...
          <text x="8" y="13" fill="#94a3b8" fontSize="8" fontWeight="bold" fontFamily="monospace">PERIOD (T)</text>
          <text x="8" y="27" fill="#34d399" fontSize="12" fontWeight="bold" fontFamily="monospace">{period.toFixed(3)} s</text>
        </g>

        <g transform="translate(144, 142)">
          <rect x="0" y="0" width="112" height="34" rx="6" fill="#18181b" stroke="#27272a" strokeWidth="1" opacity="0.92" />
          <text x="8" y="13" fill="#94a3b8" fontSize="8" fontWeight="bold" fontFamily="monospace">VELOCITY (v)</text>
          <text x="8" y="27" fill="#38bdf8" fontSize="12" fontWeight="bold" fontFamily="monospace">{velocity.toFixed(2)} m/s</text>
        </g>

        <g transform="translate(270, 142)">
          <rect x="0" y="0" width="112" height="34" rx="6" fill="#18181b" stroke="#27272a" strokeWidth="1" opacity="0.92" />
          <text x="8" y="13" fill="#94a3b8" fontSize="8" fontWeight="bold" fontFamily="monospace">FREQUENCY (f)</text>
          <text x="8" y="27" fill="#fbbf24" fontSize="12" fontWeight="bold" fontFamily="monospace">{freq.toFixed(3)} Hz</text>
        </g>
      </svg>
    </div>
  );
        ...
        <div className="w-full bg-zinc-950 rounded-xl p-3 border border-zinc-800">
          ...
          <svg viewBox="0 0 400 180" className="w-full h-auto">
            ...
            <g transform="translate(30, 90)">
              ...
              <text x="0" y="4" fill="#fef08a" fontSize="9" fontWeight="bold" textAnchor="middle" fontFamily="monospace">{v.V}V</text>
            </g>
            {/* Resistor */}
            <g transform="translate(370, 90)">
              <rect x="-14" y="-25" width="28" height="50" rx="4" fill="#451a03" stroke="#f97316" strokeWidth="1.5" />
              <text x="0" y="4" fill="#ffedd5" fontSize="9" fontWeight="bold" textAnchor="middle" fontFamily="monospace">{v.R}Ω</text>
            </g>
          </svg>
        </div>
      );
      ...
      return (
        <div className="w-full bg-zinc-950 rounded-xl p-3 border border-zinc-800">
          ...
          <svg viewBox="0 0 400 120" className="w-full h-auto">
            ...
            <text x="180" y="68" fill="#e0e7ff" fontSize="11" fontWeight="bold" textAnchor="middle">{v.m} kg</text>
            ...
            <text x={215 + arrowLen / 2} y="55" fill="#4ade80" fontSize="10" fontFamily="monospace" fontWeight="bold">F={force.toFixed(0)}N</text>
          </svg>
        </div>
      );
    },
    ...
    renderVisual: (v, r) => (
      <div className="w-full bg-zinc-950 rounded-xl p-3 border border-zinc-800">
        ...
        <svg viewBox="0 0 360 140" className="w-full h-auto">
          ...
          <text x="195" y="60" fill="#34d399" fontSize="11" fontWeight="bold" textAnchor="middle" fontFamily="monospace">c = {r.primaryValue}</text>
        </svg>
      </div>
    ),
  },
