...
export default function App() {
  ...
  return (
    <FasShell app={fas} appName="FormulaPad">
      <div 
        className="w-full min-h-screen overflow-x-auto overflow-y-auto box-border"
        style={{ WebkitOverflowScrolling: 'touch', touchAction: 'pan-x pan-y pinch-zoom' }}
      >
        <div 
          className="max-w-7xl mx-auto px-3 sm:px-6 py-4 sm:py-6 font-sans text-[var(--ink,#0f172a)] min-h-[calc(100vh-80px)] pb-16 w-full max-w-full box-border"
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-[var(--border,#e2e8f0)] pb-4">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="min-h-[40px] px-3.5 py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-750 text-xs sm:text-sm font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5 transition-colors touch-manipulation shadow-2xs cursor-pointer"
                >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 border-b border-[var(--border,#e2e8f0)] pb-2.5 sm:pb-3">
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                <button
                  ...
                  className="min-h-[36px] sm:min-h-[40px] px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-750 text-xs sm:text-sm font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5 transition-colors touch-manipulation shadow-2xs cursor-pointer shrink-0"
                >
                  <ArrowLeft className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  <span className="hidden xs:inline">Back to {subjectMeta[activeFormula.subject].name}</span>
